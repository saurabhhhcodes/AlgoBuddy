...
- 🎬 Interactive, step-by-step algorithm and data structure visualizations.
- 📚 Covers core DSA concepts including Sorting, Searching, Trees, Linked Lists, Stacks, Queues, and HashMaps.
- 🤖 AI-powered assistant for concept explanations and learning support.
- 📊 Built-in progress tracking with dashboards and learning streaks.
- 📝 Integrated blog platform for theory and in-depth explanations.
- 🌙 Modern, responsive UI with Dark/Light mode support.
- 🔐 Secure authentication using Google OAuth and Cloudflare Turnstile.
...
| #️⃣ HashMap | Insert, Search, Delete, Collision Handling | ✅ |
...
The following roadmap outlines the project's ongoing development goals.
...
| 🚧 | Expand the collection of algorithm and data structure visualizations |
| 🚧 | Improve accessibility and mobile experience |
| 🚧 | Enhance learning resources and documentation |
| 🔜 | Introduce additional educational content and practice modules |
| 🔜 | Continue community-driven improvements and feature enhancements |
