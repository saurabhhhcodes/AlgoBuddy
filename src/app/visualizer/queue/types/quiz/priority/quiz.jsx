...
const QueueQuiz = () => {
  ...
  correctAnswer: 2,
  explanation: "A min-priority queue always removes the element with the lowest priority value first."
},
{
  question: "Which real-world application commonly uses a priority queue?",
  options: [
    "Browser history",
  ...
  correctAnswer: 1,
  explanation: "Printer job scheduling uses priority queues to process high-priority print jobs before lower-priority ones."
},
{
  question: "What happens when two elements have the same priority in a priority queue?",
  options: [
    "One of them is discarded",
    "The queue becomes invalid",
    "They are usually processed in insertion order (implementation dependent)",
    "Both are removed together"
  ],
  correctAnswer: 2,
  explanation: "When priorities are equal, many implementations process elements in the order they were inserted, though this depends on the implementation."
},
{
  question: "Which operation adds a new element to a priority queue?",
  options: [
    "enqueue()",
    "insert()",
    "extractMax()",
  ...
  correctAnswer: 1,
  explanation: "The insert() operation adds a new element while maintaining the priority queue property."
},
{
  question: "Which statement best describes a priority queue?",
  options: [
    "Elements are always removed in FIFO order.",
    "Elements are always removed in LIFO order.",
    "Elements are removed according to their priority.",
    "Elements are stored in sorted order at all times."
  ],
  correctAnswer: 2,
  explanation: "A priority queue removes elements based on their assigned priority rather than their insertion order."
},
  ];
