...
export default function VoiceAgent() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 left-4 sm:bottom-6 sm:left-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-primary text-white shadow-lg hover:bg-primary/90 transition"
