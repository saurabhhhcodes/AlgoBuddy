...
export default function PolishQuizClient() {
  const quizzes = [
    {
      title: "Postfix Quiz",
      description: "Test your understanding of Postfix Expression Evaluation, operator precedence, and stack states.",
      href: "/visualizer/stack/polish/quiz/postfix",
      filename: "postfix_eval_quiz.js",
    },
    {
      title: "Prefix Quiz",
      description: "Test your understanding of Prefix Expression Evaluation, right-to-left parsing, and operator applications.",
      href: "/visualizer/stack/polish/quiz/prefix",
      filename: "prefix_eval_quiz.js",
    },
  ];
      ...
      <section className="relative pt-6 pb-4">
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-3xl font-black mb-2">
            Polish Notation Evaluation Quiz Portal
          </h1>
          <p className="text-[14px] text-surface-600 dark:text-surface-400 font-medium">
            Choose a quiz to test your understanding of Prefix and Postfix evaluation algorithms.
          </p>
        </div>
      </section>
