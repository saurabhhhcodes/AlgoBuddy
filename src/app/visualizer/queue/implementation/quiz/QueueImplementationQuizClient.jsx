...
export default function QueueImplementationQuizClient() {
  const quizzes = [
    {
      ...
      href: "/visualizer/queue/implementation/quiz/array",
      filename: "queue_array_impl_quiz.js",
    },
    {
      ...
      href: "/visualizer/queue/implementation/quiz/linked-list",
      filename: "queue_linked_list_impl_quiz.js",
    },
  ];
      ...
      <section className="relative pt-6 pb-4">
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-3xl font-black mb-2">
            Queue Implementation Quiz Portal
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          {quizzes.map((quiz, index) => (
            <motion.div
              ...
              className="group flex flex-col h-full rounded-2xl border border-emerald-500/20 dark:border-emerald-500/30 bg-white dark:bg-[#1a1a1a] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300"
            >
              {/* Top Bar */}
              <div className="flex items-center justify-between px-4 py-2.5 bg-emerald-500/10 dark:bg-emerald-500/20 border-b border-emerald-500/20 dark:border-emerald-500/30">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h2 className="text-[20px] font-extrabold text-surface-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors mb-2">
                    {quiz.title}
                  </h2>
                ...
                <Link href={quiz.href} className="block mt-auto w-full">
                  <button className="w-full h-11 rounded-xl bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white font-bold text-[14px] flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all">
