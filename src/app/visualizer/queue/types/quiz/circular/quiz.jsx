...
const QueueQuiz = () => {
  const questions = [
    ...
    {
  question: "Which real-world application commonly uses a circular queue?",
  options: [
    "Browser history",
  ...
  correctAnswer: 1,
  explanation: "Circular queues are widely used in Round Robin CPU Scheduling to efficiently rotate processes."
},
{
  question: "What happens when an enqueue operation is attempted on a full circular queue?",
  options: [
    "The oldest element is automatically removed",
    "The queue overflows",
    "The queue doubles its size",
    "The rear pointer resets to zero"
  ],
  correctAnswer: 1,
  explanation: "Attempting to enqueue into a full circular queue results in an overflow condition."
},
{
  ...
  correctAnswer: 2,
  explanation: "The dequeue operation removes the front element from the circular queue."
},
{
  question: "After removing the last element from a circular queue, what is commonly done with the front and rear pointers?",
  options: [
    "Set both to -1",
    "Set both to capacity",
    "Set front to 0 and rear to capacity - 1",
    "Keep them unchanged"
  ],
  correctAnswer: 0,
  explanation: "In many implementations, both front and rear are reset to -1 when the queue becomes empty."
},
{
  question: "Which data structure property makes a circular queue more efficient than a linear queue?",
  options: [
    "Elements are automatically sorted",
    "Memory locations are reused after dequeue operations",
    "Elements can only be inserted at the front",
    "It supports recursive traversal"
  ],
  correctAnswer: 1,
  explanation: "A circular queue reuses freed memory locations, avoiding the wasted space problem of a linear queue."
},
  ];
