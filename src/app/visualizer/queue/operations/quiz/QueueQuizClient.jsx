...
export default function QueueQuizClient() {
  const quizzes = [
    {
      title: "Enqueue & Dequeue Quiz",
      description:
        "Practice enqueue and dequeue operations, queue insertion, removal, and FIFO behavior.",
      href: "/visualizer/queue/operations/quiz/enqueue-dequeue",
      filename: "queue_operations_quiz.js",
    },
    {
      title: "Peek Front Quiz",
      description:
        "Practice accessing the front element without removing it from the queue.",
      href: "/visualizer/queue/operations/quiz/peek",
      filename: "queue_peek_quiz.js",
    },
    {
      title: "Is Empty Quiz",
      description:
        "Practice determining whether a queue contains any elements.",
      href: "/visualizer/queue/operations/quiz/isempty",
      filename: "queue_isempty_quiz.js",
    },
    {
      title: "Is Full Quiz",
      description:
        "Practice identifying whether a queue has reached its maximum capacity.",
      href: "/visualizer/queue/operations/quiz/isfull",
      filename: "queue_isfull_quiz.js",
    },
  ];
      ...
      <section className="relative pt-6 pb-4">
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <p className="text-[14px] text-surface-600 dark:text-surface-400 font-medium">
            Choose a Queue Operations quiz to test your conceptual understanding
